...
// Added Test that call  CelsiusRunner and FahrenheitRunner.
// But needed to delete the body of main methods (String [] args) in CelsiusRunner and FahrenheitRunner
// How to call this method without deleted (String [] args) ??
// --------------------------------------------------------------------------------------
//  @Test
//  public static void main(String[] args) {
//  CelsiusRunner CelsiusConverter = new CelsiusRunner();
//  CelsiusConverter.main();
//  FahrenheitRunner FahrenheitConverter = new FahrenheitRunner();
//  FahrenheitConverter.main();
//  }
// -------------------------------------------------------------------------
// I can only call it with declared myString, but the method don't use these String data.
// So this MyString seems useless.
//-------------------------------------------------------------------
//  @Test
//  public static void main(String[] args) {
//  String[] myStrings = { "125", "38", "666" };
//  CelsiusRunner CelsiusConverter = new CelsiusRunner();
//  CelsiusConverter.main(myStrings);
//  }
